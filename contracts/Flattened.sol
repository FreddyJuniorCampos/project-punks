...
// File contracts/FreddyPunksDNA.sol

pragma solidity ^0.8.0;

contract FreddyPunksDNA {
    ...
    // This pseudo random function is deterministic and should not be used to production
    // For production is recommend "The Chainlink"
...
// File contracts/FreddyPunks.sol
...
contract FreddyPunks is ERC721, ERC721Enumerable, FreddyPunksDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("FJNFT", "FJNFTS") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No FreddyPunks left");
